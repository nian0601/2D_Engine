...
#include "FW_Assert.h"
bool FW_FileSystem::GetAllFilesFromDirectory(const char* aDirectory, FW_GrowingArray<FileInfo>& someOutFilePaths)
{
...
bool FW_FileSystem::UpdateFileInfo(FW_GrowingArray<FileInfo>& someFiles)
{
...
void FW_FileSystem::ReadEntireFile(const FW_String& aFilePath, FileContent& aFileContentOut)
{
	FILE* file;
